...
python cache_flickr.py --model_path /scratch/shashwat.s/diff_prior_ema855M.pth --device cuda --num_samples 10 --split 0.01

scp /scratch/shashwat.s/*.h5 shashwat.s@ada:/share1/shashwat.s/flickr_cache/